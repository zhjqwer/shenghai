...
public class UserExtend implements Serializable {
    ...
    public UserExtend(Integer id, Integer uId, String realName, String idCard, String idCardImgFrontal, String idCardImgBack, String sex, Date birthday, Integer grade, String certificateImgFrontal, String certificateImgBack, Integer shipId, Integer commentId, String drivingLicenseId, String drivingLicenseImgFrontal, String drivingLicenseImgBack, Date drivingLicenseStartTime, Date drivingLicenseEndTime, String remarks, String spareOne, String spareTwo, Date registerTime, Date updateTime, Integer updateName) {
        this.id = id;
        this.uId = uId;
        this.realName = realName;
        this.idCard = idCard;
        this.idCardImgFrontal = idCardImgFrontal;
        this.idCardImgBack = idCardImgBack;
        this.sex = sex;
        this.birthday = birthday;
        this.grade = grade;
        this.certificateImgFrontal = certificateImgFrontal;
        this.certificateImgBack = certificateImgBack;
        this.shipId = shipId;
        this.commentId = commentId;
        this.drivingLicenseId = drivingLicenseId;
        this.drivingLicenseImgFrontal = drivingLicenseImgFrontal;
        this.drivingLicenseImgBack = drivingLicenseImgBack;
